...
function showActions() {
    ...
    if ($('#actions').height() < 320 || !$('#actions').is(':visible')) {
        $('#actions').show().animate({
            height: 320
        })
    } else {
        $('#actions').animate({
...
function homepageModule() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            _homepageLayoutInfos[$.listview.SIMPLE] = {
                height: '35%',
                count: 4,
                txtcolor: _appConfig.listtxtcolor,
                txtbgcolor: _appConfig.listtxtbgcolor
            }
            _homepageLayoutInfos[$.listview.ARROW] = {
                height: '40%',
                count: 4,
                txtcolor: _appConfig.listtxtcolor,
                txtbgcolor: _appConfig.listtxtbgcolor
            }
            _homepageLayoutInfos[$.listview.ICONS] = {
                height: '50%',
                count: 10,
                txtcolor: _appConfig.iconstxtcolor,
                txtbgcolor: 'transparent'
            }
            _homepageLayoutInfos[$.listview.TILES] = {
                height: '52%',
                count: 4,
                txtcolor: _appConfig.listtxtcolor,
                txtbgcolor: _appConfig.listtxtbgcolor
            ...
            var options = {
                items: items,
                "type": _appConfig.homepagetype,
                "click": 'showPage',
                "selectedKey": "",
                "pagination": true,
                "cols3": true,
                "pgPosition": 'top',
                "txtcolor": _homepageLayoutInfos[_appConfig.homepagetype].txtcolor,
                "txtbgcolor": _homepageLayoutInfos[_appConfig.homepagetype].txtbgcolor,
                "bgcolor": _appConfig.bgcolor,
                "titlecolor": _appConfig.titlecolor,
                /* "sort":"title asc",
                 "listPosition": 'top', */
                "count": _homepageLayoutInfos[_appConfig.homepagetype].count
            };
            $('#footer').css('height', _homepageLayoutInfos[_appConfig.homepagetype].height)
            $('#footer').listview(options)
        }
    });
...
function planDetails(planid) {
    ...
    var html = '<div onclick="zoomIn()" style="text-align: center; width: 100%;"><img src="images/icons/zoomin.png" width="48" height="48"/></div>'
